...
<div class="container pt-5 text-white">
    <div class="d-flex align-items-center">
        <h1>{{ $post->title }}</h1>
        <div class="ms-3">
            <a href="{{ route('edit', $post->id) }}" class="btn btn-warning btn-sm "><i class="fas fa-pencil-alt"></i></a>
            <button data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn-danger btn-sm ms-2"><i class="fas fa-trash"></i></button>
        </div>
    </div>
